...
public class RatingServlet extends HttpServlet
{
   ...
   ********************************************************* */
   private void PrintBody (PrintWriter out, String lhs, String rhs, String rslt)
   {
      ...
      out.println("<input type='radio' name='radio1' id='eh' value='eh'/>");
      out.println("<label for='eh'>eh</label><br>");
      out.println("<input type='radio' name='radio1' id='ok' value='ok'/>");
      out.println("<label for='ok'>ok</label><br>");
      out.println("<input type='radio' name='radio1' id='cute' value='cute'/>");
      out.println("<label for='cute'>cute</label><br>");
      out.println("<input type='radio' name='radio1' id='adorable' value='adorable'/>");
      out.println("<label for='adorable'>adorable sort of cute </label><br>");
      out.println("<input type='radio' name='radio1' id='please buy me one cute' value='please buy me one cute'/>");
      ...
      out.println("<input type='radio' name='radio2' id='eh' value='eh'/>");
      out.println("<label for='eh'>eh</label><br>");
      out.println("<input type='radio' name='radio2' id='ok' value='ok'/>");
      out.println("<label for='ok'>ok</label><br>");
      out.println("<input type='radio' name='radio2' id='cute' value='cute'/>");
      out.println("<label for='cute'>cute</label><br>");
      out.println("<input type='radio' name='radio2' id='adorable' value='adorable'/>");
      out.println("<label for='adorable'>adorable sort of cute </label><br>");
      out.println("<input type='radio' name='radio2' id='please buy me one cute' value='please buy me one cute'/>");
      out.println("<label for='please buy me one cute'>\"please buy me one\" sort of cute</label><br>");
      out.println("</div>");
      ...
      out.println("<input type='radio' name='radio3' id='eh' value='eh'/>");
      out.println("<label for='eh'>eh</label><br>");
      out.println("<input type='radio' name='radio3' id='ok' value='ok'/>");
      out.println("<label for='ok'>ok</label><br>");
      out.println("<input type='radio' name='radio3' id='cute' value='cute'/>");
      out.println("<label for='cute'>cute</label><br>");
      out.println("<input type='radio' name='radio3' id='adorable' value='adorable'/>");
      out.println("<label for='adorable'>adorable sort of cute </label><br>");
      out.println("<input type='radio' name='radio3' id='please buy me one cute' value='please buy me one cute'/>");
      out.println("<label for='please buy me one cute'>\"please buy me one\" sort of cute</label><br>");
      out.println("</div>");
      ...
      out.println("<input type='radio' name='radio4' id='eh' value='eh'/>");
      out.println("<label for='eh'>eh</label><br>");
      out.println("<input type='radio' name='radio4' id='ok' value='ok'/>");
      out.println("<label for='ok'>ok</label><br>");
      out.println("<input type='radio' name='radio4' id='cute' value='cute'/>");
      out.println("<label for='cute'>cute</label><br>");
      out.println("<input type='radio' name='radio4' id='adorable' value='adorable'/>");
      out.println("<label for='adorable'>adorable sort of cute </label><br>");
      out.println("<input type='radio' name='radio4' id='please buy me one cute' value='please buy me one cute'/>");
      out.println("<label for='please buy me one cute'>\"please buy me one\" sort of cute</label><br>");
      out.println("</div>");
